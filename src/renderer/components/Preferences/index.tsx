          ...
          <article>
            ...
            <label htmlFor="showMenuBarOnLinux">
              ...
              <Switch
                ...
                onChange={ (e: React.ChangeEvent<HTMLInputElement>) => setShowMenuBarOnLinux(e.target.checked) }
              />
            </label>
            ...
            <label htmlFor="revertTrayIcon">
              ...
              <Switch
                ...
                id="revertTrayIcon"
                onChange={ (e: React.ChangeEvent<HTMLInputElement>) => setRevertTrayIcon(e.target.checked) }
              />
            </label>
            ...
            <label htmlFor="showNotification">
              ...
              <Switch
                ...
                id="showNotification"
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setShowNotification(e.target.checked) }
              />
            </label>
            ...
            <label htmlFor="scrobble">
              ...
              <Switch
                ...
                id="scrobble"
                onChange={ (e: React.ChangeEvent<HTMLInputElement>) => preferences.setScrobble(e.target.checked) }
              />
            </label>
            <label
              style={{
          ...
          <article>
            ...
            <label htmlFor="enginerOfQQ">
              ...
              <Switch
                ...
                id="enginerOfQQ"
                onChange={ (e: React.ChangeEvent<HTMLInputElement>) => setEnginers({ QQ: e.target.checked }) }
              />
            </label>
            <label htmlFor="enginerOfMiGu">
              ...
              <Switch
                ...
                id="enginerOfMiGu"
                onChange={ (e: React.ChangeEvent<HTMLInputElement>) => setEnginers({ MiGu: e.target.checked }) }
              />
            </label>
            <label htmlFor="enginerOfXiami">
              ...
              <Switch
                ...
                id="enginerOfXiami"
                onChange={ (e: React.ChangeEvent<HTMLInputElement>) => setEnginers({ Xiami: e.target.checked }) }
              />
            </label>
            <label htmlFor="enginerOfKugou">
              ...
              <Switch
                ...
                id="enginerOfKugou"
                onChange={ (e: React.ChangeEvent<HTMLInputElement>) => setEnginers({ Kugou: e.target.checked }) }
              />
            </label>
            <label htmlFor="enginerOfKuwo">
              ...
              <Switch
                ...
                id="enginerOfKuwo"
                onChange={ (e: React.ChangeEvent<HTMLInputElement>) => setEnginers({ Kuwo: e.target.checked }) }
              />
            </label>
            <label htmlFor="enginerOfBaidu">
              ...
              <Switch
                ...
                id="enginerOfBaidu"
                onChange={ (e: React.ChangeEvent<HTMLInputElement>) => setEnginers({ Baidu: e.target.checked }) }
              />
            </label>
          </article>
